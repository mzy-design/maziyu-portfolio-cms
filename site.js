(async () => {
  ...
  if (page === 'about' && !matchMedia('(prefers-reduced-motion:reduce)').matches) {
    ...
    document.querySelectorAll('.experience-capability').forEach(item => experienceObserver.observe(item));
  }
  if (page === 'contact') {
